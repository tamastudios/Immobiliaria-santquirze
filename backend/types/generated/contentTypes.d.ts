...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Contactos recibidos desde la web (CRM)';
    displayName: 'Lead';
    pluralName: 'leads';
    singularName: 'lead';
  };
  ...
  attributes: {
    ...
    propiedadRef: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    area: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    ...
    city: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Sant Quirze del Vall\u00E8s'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    energyCertificate: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'en tr\u00E1mite'>;
    ...
    operation: Schema.Attribute.Enumeration<['venta', 'alquiler']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'venta'>;
    price: Schema.Attribute.Integer & Schema.Attribute.Required;
    propertyType: Schema.Attribute.Enumeration<
      ['piso', 'casa', 'chalet', 'duplex', 'local', 'terreno']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'piso'>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    tag: Schema.Attribute.Enumeration<
      ['nuevo', 'rebajado', 'exclusiva', 'vendido', 'reservado']
    >;
